...
class Options extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Event_store\Client\Persistent_subscriptions\UpdateReq\StreamOptions $stream
     *     @type \Event_store\Client\Persistent_subscriptions\UpdateReq\AllOptions $all
     *     @type \Event_store\Client\StreamIdentifier $stream_identifier
     *     @type string $group_name
     *     @type \Event_store\Client\Persistent_subscriptions\UpdateReq\Settings $settings
     * }
     */
     ...
     * @return \Event_store\Client\Persistent_subscriptions\UpdateReq\StreamOptions|null
     */
    ...
    /**
     * Generated from protobuf field <code>.event_store.client.persistent_subscriptions.UpdateReq.StreamOptions stream = 4;</code>
     * @param \Event_store\Client\Persistent_subscriptions\UpdateReq\StreamOptions $var
     * @return $this
     */
    public function setStream($var)
    {
        GPBUtil::checkMessage($var, \Event_store\Client\Persistent_subscriptions\UpdateReq\StreamOptions::class);
     ...
     * @return \Event_store\Client\Persistent_subscriptions\UpdateReq\AllOptions|null
     */
    ...
    /**
     * Generated from protobuf field <code>.event_store.client.persistent_subscriptions.UpdateReq.AllOptions all = 5;</code>
     * @param \Event_store\Client\Persistent_subscriptions\UpdateReq\AllOptions $var
     * @return $this
     */
    public function setAll($var)
    {
        GPBUtil::checkMessage($var, \Event_store\Client\Persistent_subscriptions\UpdateReq\AllOptions::class);
    ...
    /**
     * Generated from protobuf field <code>.event_store.client.persistent_subscriptions.UpdateReq.Settings settings = 3;</code>
     * @return \Event_store\Client\Persistent_subscriptions\UpdateReq\Settings|null
     */
    ...
    /**
     * Generated from protobuf field <code>.event_store.client.persistent_subscriptions.UpdateReq.Settings settings = 3;</code>
     * @param \Event_store\Client\Persistent_subscriptions\UpdateReq\Settings $var
     * @return $this
     */
    public function setSettings($var)
    {
        GPBUtil::checkMessage($var, \Event_store\Client\Persistent_subscriptions\UpdateReq\Settings::class);
        $this->settings = $var;
...
class_alias(Options::class, \Event_store\Client\Persistent_subscriptions\UpdateReq_Options::class);
