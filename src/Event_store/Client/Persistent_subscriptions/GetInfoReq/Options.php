...
namespace Event_store\Client\Persistent_subscriptions\GetInfoReq;
...
class_alias(Options::class, \Event_store\Client\Persistent_subscriptions\GetInfoReq_Options::class);
