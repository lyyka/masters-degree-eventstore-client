...
/**
 * Generated from protobuf message <code>event_store.client.streams.ReadResp.Position</code>
 */
...
class_alias(Position::class, \Event_store\Client\Streams\ReadResp_Position::class);
